...
const TeamChatView: React.FC<TeamChatViewProps> = ({ team, currentUser, onBack, onUpdateTeam, addNotification }) => {
    ...
    return (
        <div className="fixed inset-0 h-screen flex flex-col text-white animate-fade-in team-chat-bg">
            ...
            {/* Messages */}
            <main className="relative z-10 flex-grow overflow-y-auto p-4 min-h-0">
                {isLoading ? (
