...
const postsToSeed: ForumPost[] = [
    {
        ...
        imageUrls: ['https://picsum.photos/seed/partido1/1200/800', 'https://picsum.photos/seed/partido2/1200/800'], 
        tags: ['Fútbol', 'Debate'],
...
export const addPost = async (postData) => {
    if (isFirebaseConfigured) {
        ...
        const dataToSave = { content, imageUrls: imageUrls || null, tags, authorId, authorName, authorProfilePicture: authorProfilePicture || null, isFlagged: isFlagged || false, createdAt: firebase.firestore.FieldValue.serverTimestamp(), updatedAt: null, commentCount: 0, reactionCounts: {} };
