...
const App: React.FC = () => {
    ...
    const handleToggleFavorite = async (complexId: string) => {
        ...
        setUser({ ...user, favoriteFields: newFavorites });
    ...
    const handleRemoveProfilePicture = async () => {
        ...
        setUser(prevUser => {
            ...
            const { profilePicture, ...rest } = prevUser;
            return rest;
        });
    ...
    return (
        <div className="bg-slate-50 min-h-screen dark:bg-gray-900 transition-colors duration-300">
            ...
            {showHeader && <Header user={user} onNavigate={handleNavigate} onLogout={handleLogout} notifications={notifications} onDismiss={dismissNotification}/>}
